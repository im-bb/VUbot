...
RUN wget https://raw.githubusercontent.com/im-bb/vuserbot/master/virtualbotmain.py
RUN wget https://raw.githubusercontent.com/im-bb/vuserbot/master/requirements.txt
